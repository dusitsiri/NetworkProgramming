...
public class Server extends javax.swing.JFrame {
    ...
    public void b_endActionPerformed(java.awt.event.ActionEvent evt) {
        if (ta_chat.getText().equals("Server started...\n")) {
            try {
                Thread.sleep(3000);
    ...
    public void b_startActionPerformed(java.awt.event.ActionEvent evt) {
    ...
    public void b_clearActionPerformed(java.awt.event.ActionEvent evt) {
        ta_chat.setText("");
    }
